...
const RULES: { test: (s: string) => boolean; reply: string }[] = [
  ...
  },
  {
    ...
    reply:
      "On the home page, switch to the UI and UX Prototypes tab to view Vestige and Destinate. Both projects emphasize Figma, user flows, and systems thinking alongside her full stack builds.",
  },
  {
    test: (s) =>
      s.includes("project") ||
